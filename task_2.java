...
public void checkIsAdultWhenAgeIsLessThan18False() {
    ...
    assertEquals("Ожидалось, что пользователю младше 18 лет будет возвращено значение false", false, isAdult);
}
...
public void checkIsAdultWhenAgeIs18True() {
    ...
    assertEquals("Ожидалось, что пользователю в возрасте 18 лет будет возвращено значение true", true, isAdult);
}
